...
<div class="block-header">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                               CẬP NHẬT CHUYẾN BAY
                                <small>Mời bạn cập nhập thông tin chuyến bay</small>
                            </h2>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                      <input type="date" name="cb_thoidiem" value="<?php echo $dong['cb_thoidiem'] ?>" >
    ...
    <option value="Còn">Còn</option>
     <option value="Hết">Hết</option>
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="timepicker form-control" name="cb_giocatcanh_dukien" value="<?php echo $dong['cb_giocatcanh_dukien'] ?>">
                                        </div>
                                   
                              
									<h2 class="card-inside-title">Giờ hạ cánh dự kiến</h2>
				
                                        <div class="form-line">
                                            <input type="text" class="timepicker form-control" name="cb_giohacanh_dukien" value="<?php echo $dong['cb_giohacanh_dukien'] ?>">
                                        </div>
                               
									<h2 class="card-inside-title">Giờ cất cánh chính thức</h2>
			
                                        <div class="form-line">
                                            <input type="text" class="timepicker form-control" name="cb_giocatcanh_chinhthuc" value="<?php echo $dong['cb_giocatcanh_chinhthuc'] ?>">
                                        </div>
                                 
									<h2 class="card-inside-title">Giờ hạ cánh chính thức</h2>
				 
                                        <div class="form-line">
                                            <input type="text" class="timepicker form-control" name="cb_giohacanh_chinhthuc" value="<?php echo $dong['cb_giohacanh_chinhthuc'] ?>">
                                        </div>
  ...
  <?php
$resulthv = mysql_query("SELECT * FROM hang_ve",$conn);while ($rowhv = mysql_fetch_array($resulthv)){
			if($rowhv['hv_ma']==$dong['hv_ten']) $selected='selected="selected"'; else $selected='';
			echo "<option ".$selected." value='".$rowhv['hv_ma']."'>".$rowhv['hv_ten']."</option>";}
		?>
