<div class="block-header">
                <h2>THÊM CHUYẾN BAY KHUYẾN MÃI</h2>
            </div>
			<!-- Input -->
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="?quanly=chuyenbaykhuyenmai&ac=lietke">Danh sách khuyến mãi</a></li>
						...
						<form action="modules/quanlychuyenbaykhuyenmai/xuly.php" method="post" enctype="multipart/form-data">
                        <div class="body">
	...
	include ('../connect.php');
		...
		while ($rowkm = mysql_fetch_array($resultkm)){
			echo "<option value='".$rowkm['km_ma']."'>".$rowkm['km_ten']."</option>";}
	?>
                                    </select>
                                </div>
    ...
    <div class="row clearfix">
                                <div class="col-sm-6">
                                    <select  name="cb_ma" required>
                                      <?php
	include ('../connect.php');
		$resultdv = mysql_query("SELECT * FROM tuyen_bay",$conn);
		while ($rowdv = mysql_fetch_array($resultdv)){
			echo "<option value='".$rowdv['tb_ma']."'>".$rowdv['tb_ten']."</option>";}
	?>
                                    </select>
                                </div>
