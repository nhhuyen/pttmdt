...
<table width="200" border="1">
  <tr>
   ...
   <tr>
    ...
    <td width="87"><input type="date" name="cb_thoidiem"></td>
  </tr>
    <tr>
    <td>Tình trạng</td>
    ...
    <td width="87"><input type="time" name="cb_giocatcanh_dukien"></td>
  </tr>
   <tr>
    <td width="97">Giờ hạ cánh dự kiến</td>
    <td width="87"><input type="time" name="cb_giohacanh_dukien"></td>
  </tr>
  <tr>
    <td width="97">Giờ cất cánh chính thức</td>
    <td width="87"><input type="time" name="cb_giocatcanh_chinhthuc"></td>
  </tr>
     <tr>
    <td width="97">Giờ hạ cánh chính thức</td>
    <td width="87"><input type="time" name="cb_giohacanh_chinhthuc"></td>
  </tr>
   <tr>
  <?php
