...
$(function bn() {
	...
	$(window).on('resize', function bn() {
        resetWH();
    });
    

	slider.each(function bn() {
        sliderOlLi.click(function bn() {
            $(this).addClass('slider-active').siblings().removeClass('slider-active');
            runSlider();
        });
    });
    
    sliderFaRight.on('click', function bn() {
        runRight();
    });
    sliderFaLeft.on('click', function bn() {
        runLeft();
    });
    
    slider.find('.fa').hover(function bn() {
