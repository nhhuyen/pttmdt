...
<?php 
	...
	if($row<>0){?>
		...
		<tr>
		<th>STT</th><th width="300px" height="40px">Hãng vé</th><th width="300px">Tuyến bay</th><th>Loại vé</th><th>Thời gian</th><th>Xóa</th>
		<tr>
<?php	}else{
...
<td width="300px"><?php echo $dong['tb_ten'] ?></td>
