						...
						<div class="box-item-content" data-id="pnFlightDetailTemplate">
							<div class="flight-detail">         
								...
								<div class="depart">             
									...
									<div class="airport"><?php echo 'Sân bay: '.$sb_di ?> <br><p style="margin-top:5px"> Nhà ga: </p></div>             
								...
								<div class="arrival">             
									...
									<p style="margin-top:5px">Nhà ga:</p></div>             
							...
							<div class="stop-info" style="display:none">         Dừng tại:         Sân bay Tân Sơn Nhất.         Thời gian dừng: 00h 00p.         
								<span style="display:none"><span class="fa fa-warning"></span> Lưu ý: Điểm dừng qua đêm</span>         
								<div style="display:none">             <span class="fa fa-warning"></span> Quá cảnh tại:          </div>     
							</div>
						</div>
				</div>
			</div>
